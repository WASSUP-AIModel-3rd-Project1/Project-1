...
# one_hot encoding
pvtb_entire = pvtb_encoded[list(pvtb_encoded.columns)[1:]]
pvtb_onehot = pd.get_dummies(pvtb_entire, columns=['encoded_strata_race_label', 'encoded_strata_sex_label','encoded_geo_strata_region'])
...
for work_idx in tqdm(range(1,n_work,2)):
    ...
    test_df = pvtb_onehot[strata_one_hot_cols+strata_ordinal_cols+target_sample]
